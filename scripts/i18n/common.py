...
T = {
 'en': {
  ...
  'cta_sub': 'Size, compartments, temperatures, wrap — we tailor literally everything. Buy it outright or in leasing.',
  'buy': 'Buy', 'lease': 'Leasing', 'lease_txt': 'Spread the cost into monthly instalments — we prepare the quote your leasing company needs.',
  'buy_txt': 'The machine is yours — pay up front or in leasing. You restock it and keep all the profit.',
  'models_h': 'Your machine', 'models_em': 'to own.', 'models_eyebrow': 'How to pay for it?', 'compare': 'See the offer →',
 ...
 'cs': {
  ...
  'cta_sub': 'Velikost, přihrádky, teploty, polep — přizpůsobíme doslova všechno. Automat koupíte hned, nebo na leasing.',
  'buy': 'Koupě', 'lease': 'Leasing', 'lease_txt': 'Rozložíte náklady do měsíčních splátek — připravíme nabídku, kterou leasingová společnost potřebuje.',
  'buy_txt': 'Automat je váš — zaplatíte hned, nebo na leasing. Doplňujete ho sami a celý zisk zůstává vám.',
  'models_h': 'Automat', 'models_em': 've vašem vlastnictví.', 'models_eyebrow': 'Jak ho financovat?', 'compare': 'Zobrazit nabídku →',
 ...
 'sk': {
  ...
  'cta_sub': 'Veľkosť, priehradky, teploty, polep — prispôsobíme doslova všetko. Automat kúpite hneď alebo na leasing.',
  'buy': 'Kúpa', 'lease': 'Leasing', 'lease_txt': 'Rozložíte náklady do mesačných splátok — pripravíme ponuku, ktorú leasingová spoločnosť potrebuje.',
  'buy_txt': 'Automat je váš — zaplatíte hneď alebo na leasing. Dopĺňate ho sami a celý zisk zostáva vám.',
  'models_h': 'Automat', 'models_em': 'vo vašom vlastníctve.', 'models_eyebrow': 'Ako ho financovať?', 'compare': 'Zobraziť ponuku →',
  'faq_eyebrow': 'FAQ', 'faq_h': 'Časté', 'faq_em': 'otázky.',
  'home_crumb': 'Úvod',
  'views': 'Spredu|Z boku',
